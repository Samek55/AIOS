    ...
    <div className="flex flex-col items-center gap-2">
      <div className="relative" style={{ width: ring.size, height: ring.size }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <p style={{ fontSize: '13px', fontWeight: 700 }} className="text-[#222222] mt-0.5">{Math.round(pct * 100)}%</p>
        </div>
      </div>
      <div className="text-center">
        <p style={{ fontSize: '13px', fontWeight: 700 }} className="text-[#222222]">{ring.value.toLocaleString()}</p>
...
export default function Health() {
  ...
  const rings: Ring[] = [
    { label: 'Steps', value: 7842, goal: 10000, unit: 'steps', color: '#C2DBC4', icon: Activity, size: 90 },
    { label: 'Calories', value: 1450, goal: 2000, unit: 'kcal', color: '#F4A261', icon: Flame, size: 90 },
    { label: 'Water', value: waterLogged, goal: 8, unit: 'glasses', color: '#7BA7DC', icon: Droplets, size: 90 },
  ...
  return (
    <div className="p-4 lg:p-6 max-w-7xl mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: 700 }} className="text-[#222222]">Health & Fitness</h1>
          <p style={{ fontSize: '13px' }} className="text-[#888]">Sunday, April 5 · Health Score: <span className="text-[#7BAF80] font-semibold">78 / 100</span></p>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 bg-[#222222] rounded-xl">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <div className="flex items-center justify-between mb-5">
              <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222]">Today's Activity</h3>
              <span style={{ fontSize: '12px', fontWeight: 600 }} className="text-[#7BAF80]">On Track 🎯</span>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222]">Weekly Steps</h3>
              <div className="text-right">
                <p style={{ fontSize: '18px', fontWeight: 700 }} className="text-[#222222]">63,882</p>
                <p style={{ fontSize: '11px' }} className="text-[#7BAF80]">+12% vs last week ↑</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222]">Heart Rate Today</h3>
              <div className="flex items-center gap-2">
                <Heart size={14} className="text-red-400 fill-red-400 animate-pulse" />
                <span style={{ fontSize: '13px', fontWeight: 600 }} className="text-[#222222]">Avg: 78 BPM</span>
              </div>
            </div>
            <ResponsiveContainer width="100%" height={140}>
              <AreaChart data={heartRateData}>
                ...
                />
                <Area type="monotone" dataKey="bpm" stroke="#F4A261" strokeWidth={2} fill="url(#heartGrad)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { label: 'BMI', value: '22.4', status: 'Normal', color: '#7BAF80' },
              { label: 'Resting HR', value: '62 BPM', status: 'Excellent', color: '#C2DBC4' },
              { label: 'Blood O₂', value: '98%', status: 'Great', color: '#7BA7DC' },
              { label: 'Stress Level', value: 'Low', status: 'Relaxed', color: '#F4A261' },
            ].map(m => (
              <div key={m.label} className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-4 text-center">
                <p style={{ fontSize: '20px', fontWeight: 700 }} className="text-[#222222]">{m.value}</p>
      ...
      {activeTab === 'workout' && (
        <div className="space-y-5">
          ...
          <div className="bg-[#222222] rounded-2xl p-5 flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[#C2DBC4] flex items-center justify-center shrink-0">
              <Dumbbell size={22} className="text-[#222222]" />
            </div>
            <div className="flex-1">
              <p style={{ fontSize: '11px', fontWeight: 600 }} className="text-[#C2DBC4] uppercase tracking-wide mb-1">AI Recommendation</p>
          ...
          <div className="space-y-3">
            <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222]">Today's Workout Plan</h3>
            {workouts.map((w, i) => (
              <div key={i} className={`bg-white rounded-2xl border overflow-hidden transition-all ${completedWorkouts.includes(i) ? 'border-[#C2DBC4] opacity-75' : 'border-[#C2DBC4]/20 hover:border-[#C2DBC4]'}`}>
                <div className="flex items-center gap-4 p-4">
                  <div className="relative w-16 h-16 rounded-xl overflow-hidden shrink-0">
                    ...
                    {completedWorkouts.includes(i) && (
                      <div className="absolute inset-0 bg-[#7BAF80]/80 flex items-center justify-center">
                        <Check size={24} className="text-white" />
                      </div>
                    )}
                  </div>
                  <div className="flex-1 min-w-0">
                    <h4 style={{ fontSize: '14px', fontWeight: 600 }} className={`text-[#222222] ${completedWorkouts.includes(i) ? 'line-through opacity-50' : ''}`}>{w.name}</h4>
                  ...
                  <button
                    ...
                    className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all shrink-0 ${
                      completedWorkouts.includes(i)
                        ...
                        : 'bg-[#222222] text-white hover:bg-[#C2DBC4] hover:text-[#222222]'
                    }`}
                  >
          ...
          {/* Exercise Library */}
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222] mb-3">Exercise Library</h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {['🏋️ Strength', '🏃 Cardio', '🧘 Yoga', '🚴 Cycling', '🏊 Swimming', '⛹️ HIIT'].map(ex => (
                <button key={ex} className="py-3 px-4 bg-[#F5FAF5] rounded-xl border border-[#C2DBC4]/20 hover:bg-[#E8F3E9] hover:border-[#C2DBC4] transition-all text-center">
      ...
      {activeTab === 'nutrition' && (
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222]">Calorie Tracker</h3>
              <span style={{ fontSize: '13px' }} className="text-[#888]">Goal: 2,000 kcal</span>
            </div>
            <div className="flex items-center gap-6 mb-4">
              <div className="text-center">
                <p style={{ fontSize: '28px', fontWeight: 700 }} className="text-[#222222]">1,450</p>
                <p style={{ fontSize: '12px' }} className="text-[#888]">Consumed</p>
              </div>
              <div className="flex-1">
                <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-[#C2DBC4] rounded-full" style={{ width: '72.5%' }} />
                </div>
                <div className="flex justify-between mt-1">
                  <span style={{ fontSize: '11px' }} className="text-[#888]">72.5%</span>
                  <span style={{ fontSize: '11px', fontWeight: 600 }} className="text-[#7BAF80]">550 remaining</span>
                </div>
              </div>
            </div>
            {/* Macro breakdown */}
            <div className="grid grid-cols-3 gap-3">
              {[
                { label: 'Protein', value: 85, goal: 120, color: '#F4A261', unit: 'g' },
                { label: 'Carbs', value: 165, goal: 250, color: '#C2DBC4', unit: 'g' },
                { label: 'Fat', value: 48, goal: 65, color: '#C77DFF', unit: 'g' },
              ].map(m => (
                <div key={m.label} className="bg-[#F5FAF5] rounded-xl p-3">
                  <p style={{ fontSize: '16px', fontWeight: 700 }} className="text-[#222222]">{m.value}{m.unit}</p>
          ...
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222]">Today's Meal Plan</h3>
              <ImageWithFallback src={SALAD_IMG} alt="Nutrition" className="w-10 h-10 rounded-xl object-cover" />
            </div>
            <div className="space-y-3">
              {mealPlan.map((meal, i) => (
                <div key={i} className={`flex items-center gap-3 p-3 rounded-xl transition-all ${meal.done ? 'bg-[#E8F3E9]' : 'bg-[#F5FAF5] hover:bg-[#F0F8F0]'}`}>
                  <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${meal.done ? 'bg-[#C2DBC4]' : 'bg-white border border-[#C2DBC4]/30'}`}>
                    <meal.icon size={16} className={meal.done ? 'text-[#222222]' : 'text-[#888]'} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p style={{ fontSize: '13px', fontWeight: 600 }} className="text-[#222222]">{meal.meal}</p>
                  ...
                  {meal.done
                    ? <Check size={16} className="text-[#7BAF80] shrink-0" />
                    : <button className="text-[#bbb] hover:text-[#7BAF80] transition-colors shrink-0"><Plus size={16} /></button>
                  }
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222]">💧 Water Intake</h3>
              <span style={{ fontSize: '13px', fontWeight: 600 }} className="text-[#7BA7DC]">{waterLogged}/{waterGlasses} glasses</span>
            </div>
              ...
              {Array.from({ length: waterGlasses }).map((_, i) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg transition-all ${
                    i < waterLogged ? 'bg-[#7BA7DC]/20 scale-105' : 'bg-gray-100 opacity-40 hover:opacity-70'
                  }`}
                >
                  💧
                </button>
            ...
            <button
              ...
              className="mt-3 w-full py-2 bg-[#7BA7DC]/10 border border-[#7BA7DC]/30 rounded-xl text-[#5a87bd] hover:bg-[#7BA7DC]/20 transition-colors"
      ...
      {activeTab === 'sleep' && (
        <div className="space-y-5">
          {/* Sleep summary */}
          <div className="bg-[#222222] rounded-2xl p-6 text-white">
            <p style={{ fontSize: '12px', fontWeight: 600 }} className="text-[#C2DBC4] uppercase tracking-wide mb-1">Last Night's Sleep</p>
            ...
            <div className="grid grid-cols-3 gap-4 mt-5">
              {[
                { label: 'Deep Sleep', value: '2h 10m', color: '#7BA7DC' },
                { label: 'REM Sleep', value: '1h 45m', color: '#C77DFF' },
                { label: 'Light Sleep', value: '3h 25m', color: '#C2DBC4' },
              ].map(s => (
          ...
          {/* Sleep quality */}
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222] mb-4">Sleep Quality Score</h3>
            <div className="flex items-center gap-5">
              <div className="relative w-24 h-24">
                <svg width={96} height={96} style={{ transform: 'rotate(-90deg)' }}>
                  <circle cx={48} cy={48} r={40} fill="none" stroke="#f0f0f0" strokeWidth={10} />
                  <circle cx={48} cy={48} r={40} fill="none" stroke="#C2DBC4" strokeWidth={10}
                    strokeDasharray={`${2 * Math.PI * 40}`}
                    strokeDashoffset={`${2 * Math.PI * 40 * 0.15}`}
                    strokeLinecap="round" />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <p style={{ fontSize: '22px', fontWeight: 700 }} className="text-[#222222]">85</p>
                  <p style={{ fontSize: '9px' }} className="text-[#888]">/ 100</p>
                </div>
              </div>
              <div className="flex-1 space-y-2">
                {[
                  { label: 'Duration', score: 92, color: '#C2DBC4' },
                  { label: 'Consistency', score: 78, color: '#7BA7DC' },
                  { label: 'Deep Sleep %', score: 85, color: '#C77DFF' },
                  { label: 'Interruptions', score: 90, color: '#F4A261' },
                ].map(s => (
          ...
          {/* Sleep tips */}
          <div className="bg-white rounded-2xl border border-[#C2DBC4]/20 p-5">
            <h3 style={{ fontSize: '15px', fontWeight: 700 }} className="text-[#222222] mb-3">🌙 Sleep Tips from AIOS</h3>
            {[
              ...
              <div key={i} className="flex items-start gap-2 py-2 border-b border-[#F5FAF5] last:border-0">
